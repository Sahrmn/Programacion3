...
/* inicio  especiales para slimFramework*/
     ...
     public function ModificarUno($request, $response, $args) {
		...
		//$micd->foto=$ArrayDeParametros['foto'];
...
/* final especiales para slimFramework*/
	...
	public function ModificarCd()
	 ...
	 {
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into cds (titel,interpret,jahr,ruta_imagen)values('$this->titulo','$this->cantante','$this->año')");
			$consulta->execute();
